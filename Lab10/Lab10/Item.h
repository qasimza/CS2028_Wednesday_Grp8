#pragma once
/*
Task 2:  Reuse the class from Lab 8, Task 2 (Class to store data).  
		You will need to add the overload of the string object conversion.  
		This object conversion should return the SKU Number.
